...
class DataTransformation:
    ...
    def initiate_data_transformation(self)->artifact_entity.DataTransformationArtifact:
        ...
        #selecting target column from train andtest dataframe
        ...
        utils.save_numpy_arr_data(file_path=self.data_transformation_config.transform_test_path, array=test_arr)
        ...
        logging.info(f"data_transform_artifact: {data_transform_artifact}")
